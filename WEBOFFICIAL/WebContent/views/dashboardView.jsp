...
<body class="dark-edition">
  <div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="black" data-image="${pageContext.request.contextPath}images/dashboard/sidebar-2.jpg">
      <!--
        ...
        <ul class="nav">
          ...
          <li class="nav-item active  ">
            <a class="nav-link" href="createProduct">
              <i class="userinfo-icons">userinfo</i>
              <p>User Info</p>
            </a>
          </li>
          <!-- your sidebar here -->
	...
	<table border="1" cellpadding="5" cellspacing="1" >
       ...
       <c:forEach items="${productList}" var="product" >
          <tr>
            ...
            <td>
             	<center><img src="<%=request.getContextPath()%>/images/${product.image}" width="100px", height="100px"></image></center>
             </td> 
             <td></td>
             <td>
                <a href="detail?id=${product.id}">Detail</a>
             </td>
             <td>
                <a onclick="abc()" href="deleteProduct?id=${product.id}">Delete</a>
             </td>
              <td>
